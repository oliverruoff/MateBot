...
classNames = []
classFile = "object_detection/object.names"
with open(classFile,"rt") as f:
    classNames = f.read().rstrip("\n").split("\n")

#This is to pull the information about what each object should look like
configPath = "sensors/object_detection/ssd_mobilenet_v3_large_coco_2020_01_14.pbtxt"
weightsPath = "sensors/object_detection/frozen_inference_graph.pb"
