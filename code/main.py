...
try:
    ...
    back_left_stepper.turn_angle(360, False)
    back_right_stepper.turn_angle(360, False)
    front_left_stepper.turn_angle(360, False)
    front_right_stepper.turn_angle(360, False)
