...
try:
    ...
    front_left_stepper = stepper.stepper(
        DIR=4, STEP=3, SLP=2, M0=7, M1=8, M2=25, steps_per_revolution=200, stepper_delay_seconds=0.000005, gpio_mode=GPIO.BCM)

    front_right_stepper = stepper.stepper(
        DIR=11, STEP=9, SLP=10, M0=7, M1=8, M2=25, steps_per_revolution=200, stepper_delay_seconds=0.000005, gpio_mode=GPIO.BCM)

    back_left_stepper = stepper.stepper(
        DIR=26, STEP=19, SLP=13, M0=7, M1=8, M2=25, steps_per_revolution=200, stepper_delay_seconds=0.000005, gpio_mode=GPIO.BCM)
